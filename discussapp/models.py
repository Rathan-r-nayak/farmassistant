...
class Answers(models.Model):
    ...
    query = models.ForeignKey('Questions', models.DO_NOTHING)
    fid = models.ForeignKey('Farmer', models.DO_NOTHING, db_column='fid')
...
class Benifits(models.Model):
    ...
    stitle = models.ForeignKey('Schemes', models.DO_NOTHING, db_column='stitle')
